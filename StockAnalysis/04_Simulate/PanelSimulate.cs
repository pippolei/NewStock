...
namespace StockAnalysis.Panel
{
    public partial class PanelSimulate : UserControl
    {
        ...
        private void btn_batch_Click(object sender, EventArgs e)
        {
            ...
            int[] startdates = new int[] { 20120101, 20120401, 20120701, 20140101, 20140401, 20140701, 20170101, 20170401, 20170701, 20120101, 20120401, 20120701};
            int[] enddated = new int[] { 20140101, 20140401, 20140701, 20170101, 20170401, 20170701, 20200101, 20200401, 20200701, 20200101, 20200401, 20200701 };
